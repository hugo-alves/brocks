Brocks::Application.configure do
  ...
  config.action_mailer.default_url_options = { :host => ENV["https://boiling-coast-2335.herokuapp.com/"] }
  ...
  config.action_mailer.smtp_settings = {
    ...
    password: ENV["esCCaA_xlJCqZ1w7nI1w_g"]
  }
